...
if (
    ...
    header("Location: index.php?error=Log in to view");
    exit;
}
...
<body>
    ...
    <main>
        ...
        <header class="main_blog_header">
            <h1 class="icon-camera" id="oquefazer">Suggestions</h1>
            <p class="icon-point-down">To view the article, just click!</p>
        </header>
