...
<main>
    ...
    <div class="main_cta">
        <article class="main_cta_content">
            <div class="main_cta_content_spacer">
                <header>
                    <h1>Welcome to Turismo DF</h1>
                </header>
                <h2>A website to help you find your best schedule</h2>
                <p><a href="#oquefazer" class="btn">Know More</a></p>
            </div>
        </article>
    </div>
    <!--FIM 1ª DOBRA-->
    ...
    <section class="main_blog">
        <header class="main_blog_header">
            <h1 class="icon-location" id="oquefazer">What to do in Brasilia?</h1>
            <p class="icon-info">Here you will find the best suggestions for what to do in our capital.</p>
        ...
        <?php if ($rows) {
            ...
            echo "<p>Não existem Categorias cadastrados</p>";
        } ?>
    </section>
    ...
    <section class="main_blog">
        <header class="main_blog_header">
            <hr><br>
            <h1 class="icon-map" id="mapa">Maps</h1>
            <p class="icon-warning">For a better experience, click on "View Larger Map".</p>
        </header>

        <article>
            <h2 class="icon-map">map of Brasilia</h2>
            <iframe
        ...
        <article>
            <h2 class='bx bx-restaurant'>Map of Restaurants</h2>
            <iframe
        ...
        <article>
            <h2 class='bx bxs-hotel'>Map of Hotels</h2>
            <iframe
        ...
        <article>
            <h2 class='bx bx-plus-medical'>Map of Pharmacies</h2>
            <iframe
        ...
        <article>
            <h2 class="icon-credit-card">ATM Map</h2>
            <iframe
        ...
        <article>
            <h2 class='bx bxs-bus'>Public Transport Map</h2>
            <iframe
