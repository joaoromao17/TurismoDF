<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query = "SELECT * FROM `turismodf`.`usuarios` WHERE nome = :nome AND `password` = :password";
...
<div class="modal">
    ...
    <div class="div_login">
        <form action="index.php" method="post">
            <h1>Login</h1><br>
            <input type="text" name="nome" placeholder="Name" class="input" required autofocus>
            <br><br>
        ...
        <div class="novo__form__login">
            <a href="usuario_admin_new.php">Create an account</a>
        </div>
    </div>
