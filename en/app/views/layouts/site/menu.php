    ...
    <a href="index.php" class="logo">
        ...
        <nav class="main_header_content_menu">
            <ul>
                ...
                <li><a href="../views/index.php"><img src="assets/img/USA.jfif" width="30 px" height="20 px"></a></li>
                <li><a href="../../../esp/app/views/index.php"><img src="assets/img/espanhol.jfif" width="30 px" height="20 px"></a></li>
                <li><a href="#oquefazer">What to do?</a></li>
                <li><a href="#mapa">Maps</a></li>
                <?php 
                    ...
                    if (isset($_SESSION['usuario']) && $_SESSION['usuario']['perfil'] == 'ADM')  {
                        ...
                        echo "<li><a href='perfil_usuario.php'>Profile</a></li>";
                        echo "<li><a href='logout.php'>Logout</a></li>";
