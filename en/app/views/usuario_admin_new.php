        ...
        <div class="main_opc">
            ...
            <section class="novo__form__section">
                ...
                <form action="" method="post" class="novo__form">
                    ...
                    <input type="email" name="email" placeholder="Inform your email." required autofocus ><br><br>
                    <label for="nome">Name</label><br>
                    <input type="text" name="nome" placeholder="Enter your name."  required><br><br>
