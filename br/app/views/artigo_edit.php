<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query = "UPDATE `turismodf`.`artigos` SET 
                `titulo` = :titulo, 
                `texto` = :texto,
                `link` = :link, 
                `status` = :status, 
    ...
    $query = "SELECT * FROM `turismodf`.`artigos` WHERE id = :id";
    $stmt = $dbh->prepare($query);
    $stmt->bindParam(':id', $id);
                ...
                <form action="" method="post" class="novo__form" enctype="multipart/form-data" >
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            cols="30" 
                            rows="15" 
                            placeholder="Informe o link do artigo" 
                            required><?=isset($row['link']) ? $row['link'] : ''?></textarea>
                    </div>
                    <br><br>
                    <div>
