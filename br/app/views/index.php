...
<main>
    ...
    <div class="main_cta">
        <article class="main_cta_content">
            <div class="main_cta_content_spacer">
                <header>
                    <h1>Bem vindo ao Turismo DF</h1>
                </header>
                <h2>Um site para te ajudar a achar sua melhor programação</h2>
    ...
    <section class="main_blog">
        <header class="main_blog_header">
            <h1 class="icon-location" id="oquefazer">O que fazer em Brasília?</h1>
            <p class="icon-info">Aqui você encontra as melhores sugestões para o que fazer em nossa capital.</p>
    ...
    <section class="main_blog">
        <header class="main_blog_header">
            ...
            <strong><p class="icon-warning">Para uma melhor experiência, clique em "Ver mapa ampliado".</p></strong>
        </header>
        ...
        <article>
            <h2 class='bx bxs-hotel'>Mapa de Hotéis</h2>
            <iframe
        ...
        <article>
            <h2 class='bx bx-plus-medical'>Mapa de Farmácias</h2>
            <iframe
        ...
        <article>
            <h2 class="icon-credit-card">Mapa de Caixas Eletrônicos</h2>
            <iframe
